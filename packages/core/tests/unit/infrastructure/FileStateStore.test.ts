...
const TEST_DIR = join(process.cwd(), `.batchactions-test-${String(process.pid)}`);
...
describe('FileStateStore', () => {
  ...
  describe('saveJobState / getJobState', () => {
    ...
    it('should write valid JSON to disk', async () => {
      ...
      const parsed = JSON.parse(content) as JobState;
  ...
  describe('default directory', () => {
    it('should use .batchactions as default directory', () => {
